...
import com.ljf.gmall.ware.feign.OrderFeignService;
import com.ljf.gmall.ware.feign.ProductFeignService;
import com.ljf.gmall.ware.service.WareOrderTaskDetailService;
import com.ljf.gmall.ware.service.WareOrderTaskService;
import com.ljf.gmall.ware.service.WareSkuService;
import com.ljf.gmall.ware.vo.OrderItemVo;
import com.ljf.gmall.ware.vo.OrderVo;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    public void unlockStock(StockLockedTo to) {
        ...
        /**
         * 解锁
         * 1、查询库存工作单详情，没有查到则不用解锁库存（库存锁定时出现问题，已经自动回滚了）
         * 2、查询数据库关于这个订单锁定库存信息
         *   有：证明库存锁定成功了
         *      解锁：订单状况
         *          1、没有这个订单，必须解锁库存
        ...
        if (taskDetailInfo != null) {
            ...
            if (orderData.getCode() == 0) {
                ...
                //判断订单状态是否已取消或者订单不存在(被取消的订单getStatus() == 4)
